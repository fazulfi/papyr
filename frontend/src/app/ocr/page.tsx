  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 py-8 sm:py-12">
      ...
      <div className="mb-8 text-center flex flex-col items-center">
        ...
        <h1 className="mb-2 text-3xl font-bold tracking-tight text-navy md:text-4xl">OCR PDF</h1>
        <p className="text-base text-slate-500">
          Jadikan PDF scan memiliki text layer agar teksnya bisa dicari dan diseleksi.
        </p>
        <p className="mt-2 max-w-md text-sm text-slate-400">
          Hasil tetap berupa PDF, cocok untuk dokumen scan, foto dokumen, atau PDF berisi gambar
          teks. File diproses di server dan otomatis dihapus setelah 1 jam.
        </p>
