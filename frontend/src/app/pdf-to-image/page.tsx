...
export default function PdfToImagePage() {
  ...
  const canConvert = convertState === 'ready' && selectedPages.length > 0 && !rangeError;
    ...
    <div className="mx-auto w-full max-w-xl px-4 py-8 sm:py-12">
      ...
      <div className="mb-8 text-center flex flex-col items-center">
        ...
        <p className="mt-2 text-sm text-slate-400 max-w-md">
          Konversi slide presentasi, sertifikat, atau halaman dokumen jadi gambar untuk di-share di
          media sosial atau grup WhatsApp.
        </p>
      </div>
      ...
      {convertState === 'done' && result && (
        <div className="animate-fade-up rounded-2xl border border-accent/20 bg-white p-6 shadow-[0_4px_20px_rgba(37,99,235,0.06)]">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-semibold text-navy">Gambar berhasil dibuat!</p>
