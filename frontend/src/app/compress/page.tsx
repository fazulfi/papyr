  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 py-8 sm:py-12">
      ...
      <div className="mb-8 text-center flex flex-col items-center">
        ...
        <p className="text-base text-slate-500">Perkecil ukuran PDF tanpa mengurangi kualitas.</p>
        <p className="mt-2 text-sm text-slate-400 max-w-md">
          Cocok untuk kirim dokumen lewat WhatsApp, email kantor, atau upload ke portal pemerintah
          yang ada batas ukuran file.
        </p>
      </div>
