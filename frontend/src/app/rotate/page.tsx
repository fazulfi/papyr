...
import { getPDFPageCount, rotatePDF, downloadPDF, type PageRotationMap } from '@/lib/pdfUtils';
  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 py-8 sm:py-12">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-navy sm:text-3xl">Putar PDF</h1>
          <p className="text-sm text-slate-500">Putar halaman PDF sesuai kebutuhan.</p>
      ...
      {state === 'idle' && (
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-400">Maks {limits.maxUploadMB}MB · Format PDF</p>
          </div>
          <input
            ref={inputRef}
            type="file"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-navy truncate max-w-[200px]">{file.name}</p>
              ...
              return (
                <button
                  ...
                  className={`group relative flex flex-col items-center gap-1.5 rounded-xl border-2 p-3 transition-all hover:border-accent/60 ${
                    isRotated ? 'border-accent/40 bg-accent/5' : 'border-slate-200 bg-white'
                  }`}
                >
                  ...
                  <span className="text-xs font-medium text-slate-600">Hal {pageNum}</span>
                  {isRotated && (
      ...
      {state === 'done' && resultData && (
        <div className="flex flex-col items-center gap-4 rounded-xl border border-emerald-200 bg-emerald-50 px-6 py-10">
          ...
          <div className="text-center">
            <p className="text-base font-semibold text-emerald-800">PDF berhasil diputar!</p>
      ...
      {state === 'error' && (
        <div className="flex flex-col items-center gap-4 rounded-xl border border-rose-200 bg-rose-50 px-6 py-10">
          ...
          <div className="text-center">
            <p className="text-base font-semibold text-rose-800">Terjadi kesalahan</p>
