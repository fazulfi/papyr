...
export function validateProtectPassword(password: string, confirmPassword: string): string | null {
...
export function isValidEncryptionMethod(value: string): value is 'aes128' | 'aes256' {
