...
import { getProtectFailureReason, validateProtectFile, validateProtectPassword } from './logic';
...
export default function ProtectPage() {
  ...
  const validateFile = useCallback((f: File): string | null => validateProtectFile(f), []);
  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 py-8 sm:py-12">
      ...
      <div className="mb-8 text-center flex flex-col items-center">
        ...
        <p className="text-base text-slate-500">Lindungi file PDF Anda dengan sandi AES-256.</p>
        <p className="mt-2 text-sm text-slate-400 max-w-md">
          Tambahkan kata sandi untuk mengunci PDF Anda. File akan dienkripsi dan tersedia untuk
          diunduh selama 1 jam.
        </p>
      </div>
