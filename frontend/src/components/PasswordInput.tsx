...
export default function PasswordInput({
  ...
  const mismatch = showConfirm && password.length > 0 && confirmPassword.length > 0 && password !== confirmPassword;
    ...
    <div className="space-y-3 rounded-xl bg-white p-4 border border-slate-100 shadow-sm">
      ...
      {showConfirm && (
        <>
          ...
          {mismatch && <p className="mt-2 text-xs font-medium text-rose-500">Password tidak cocok</p>}
        </>
      )}
    </div>
  );
